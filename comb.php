...
\$PKR = new PKRoundColor();<br/>
\$roundedColor = \$PKR->getRoundedColor(\$color); <br/>
echo \$roundedColor;
EOD;
...
echo $roundedColor . "<br><br>";




$r =<<<EOD
echo (new PKRoundColor())->getRoundedColor("#f3f3dd"); <br/>
EOD;

echo $r . "<br/>Result: ";

echo (new PKRoundColor())->getRoundedColor("#f3f3dd");
